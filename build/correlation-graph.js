...
var Annotation = function () {
  function Annotation(_ref) {
    ...
    classCallCheck$$1(this, Annotation);
...
var AnnotationCollection = function () {
  function AnnotationCollection(_ref) {
    ...
    classCallCheck$$1(this, AnnotationCollection);
  ...
  createClass$$1(AnnotationCollection, [{
    key: "clearTypes",
...
var connectorCurve = function connectorCurve(_ref) {
  ...
  data = [data[0]].concat(toConsumableArray$$1(connectorData.points), [data[1]]);
...
var customType = function customType(initialType, typeSettings, _init) {
  return function (_initialType) {
    inherits$$1(customType, _initialType);

    function customType(settings) {
      classCallCheck$$1(this, customType);

      var _this3 = possibleConstructorReturn$$1(this, (customType.__proto__ || Object.getPrototypeOf(customType)).call(this, settings));
...
var d3NoteText = function (_Type) {
  inherits$$1(d3NoteText, _Type);

  function d3NoteText(params) {
    classCallCheck$$1(this, d3NoteText);

    var _this4 = possibleConstructorReturn$$1(this, (d3NoteText.__proto__ || Object.getPrototypeOf(d3NoteText)).call(this, params));
...
var ThresholdMap = function (_d3Callout) {
  inherits$$1(ThresholdMap, _d3Callout);

  function ThresholdMap() {
    classCallCheck$$1(this, ThresholdMap);
    return possibleConstructorReturn$$1(this, (ThresholdMap.__proto__ || Object.getPrototypeOf(ThresholdMap)).apply(this, arguments));
  }

  createClass$$1(ThresholdMap, [{
    key: 'mapY',
    value: function mapY(accessors) {
